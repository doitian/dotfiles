...
if [ -n "$INSTALL_APT" ]; then
  ...
  $SUDO apt-get install -y unzip vim direnv tmux build-essential autoconf flex bison texinfo libtool libreadline-dev zlib1g-dev libssl-dev python3 python3-pip
